...
: ${AMENT_CURRENT_PREFIX:="/home/user/cognipilot/cranium/install/b3rb_robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/b3rb_robot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/b3rb_robot/environment/path.sh"
